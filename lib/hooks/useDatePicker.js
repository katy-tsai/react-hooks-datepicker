...
const useDatePicker = _ref => {
  ...
  let [startTime, setStartTime] = React.useState(startDate);
  let [endTime, setEndTime] = React.useState(endDate);
  let [isOpen, setIsOpen] = React.useState(false);
  let [year, setYear] = React.useState(dayjs(startDate).year());
  let [month, setMonth] = React.useState(dayjs(startDate).month());
  let [isStartRange, setIsStartRange] = React.useState(false);
  let [ranges, setRanges] = React.useState([]);
  React.useEffect(() => {
    if (isRange) {
